...
My product line is a set of radio model user manuals. 
The definition is:
- Software intensive system -> No?
- sharing a common, managed set of features, -> Yes
- that satisfy the the specific needs of a particular market segment -> Yes
- and are using core assets in a prescribed way -> Yes
